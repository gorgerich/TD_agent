...
export const AGENT_ATTRIBUTION_CATALOG: CatalogItem[] = [
  // ── Гробы: реальные серии ПО «Фаворит» (каталог 2020, фото из каталога) ──
  // 3 «якорных» id сохранены — на них ссылаются пакеты-пресеты. clientPrice 0
  // = «цена по запросу» (в каталоге цен нет, агент проставляет).
  {
    id: "coffin-fabric-standard",
    name: "«Стандарт» ФС-4",
    category: "Гробы",
    description: "Серия Стандарт. Сосна, глянец. Размер 1,7-2,2 м.",
    imageUrl: "/catalog/coffins/fs-4.jpg",
    imagePlaceholder: "ФС-4",
    clientPrice: 18000,
    costPrice: 9000,
    quantityDefault: 1,
    availableColors: ["махагон", "белый", "светлый"],
    isRecommended: true,
    tags: ["Стандарт", "сосна", "бюджет"],
  },
  {
    id: "coffin-fs-6",
    name: "«Стандарт» ФС-6",
    category: "Гробы",
    description: "Серия Стандарт. Сосна, глянец. Размер 1,7-2,1 м.",
    imageUrl: "/catalog/coffins/fs-6.jpg",
    imagePlaceholder: "ФС-6",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["махагон", "белый"],
    tags: ["Стандарт", "сосна"],
  },
  {
    id: "coffin-fsn-4",
    name: "«Стандарт» ФСН-4",
    category: "Гробы",
    description: "Серия Стандарт. МДФ, глянец. Размер 1,7-2,1 м.",
    imageUrl: "/catalog/coffins/fsn-4.jpg",
    imagePlaceholder: "ФСН-4",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["вишня", "груша"],
    tags: ["Стандарт", "МДФ"],
  },
  {
    id: "coffin-fsn-6s",
    name: "«Стандарт» ФСН-6С",
    category: "Гробы",
    description: "Серия Стандарт. МДФ, глянец. Размер 1,7-2,1 м.",
    imageUrl: "/catalog/coffins/fsn-6s.jpg",
    imagePlaceholder: "ФСН-6С",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["вишня", "груша"],
  ...
  },
  {
    ...
    name: "«Печаль» ФСР-4",
    category: "Гробы",
    description: "Серия Стандарт, накладка-икона. Сосна, махагон, глянец.",
    imageUrl: "/catalog/coffins/fsr-4.jpg",
    imagePlaceholder: "ФСР-4",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["махагон"],
    tags: ["Печаль", "сосна", "икона"],
  },
  {
    id: "coffin-fsr-6",
    name: "«Печаль» ФСР-6",
    category: "Гробы",
    description: "Серия Стандарт, накладка-икона. Сосна, махагон, глянец.",
    imageUrl: "/catalog/coffins/fsr-6.jpg",
    imagePlaceholder: "ФСР-6",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["махагон"],
  ...
  {
    id: "coffin-lacquered",
    name: "«Классика» ФКЛ-6С",
    category: "Гробы",
    description: "Серия Классика. Сосна, глянец. Колода / Тайная вечеря.",
    imageUrl: "/catalog/coffins/fkl-6s.jpg",
    imagePlaceholder: "ФКЛ-6С",
    clientPrice: 35000,
    costPrice: 17000,
    quantityDefault: 1,
    availableColors: ["махагон", "светлый", "белый"],
    isRecommended: true,
    tags: ["Классика", "сосна"],
  },
  {
    id: "coffin-fkl-6t",
    name: "«Классика» ФКЛ-6Т",
    category: "Гробы",
    description: "Серия Классика. Сосна, глянец. Колода / Тайная вечеря.",
    imageUrl: "/catalog/coffins/fkl-6t.jpg",
    imagePlaceholder: "ФКЛ-6Т",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["махагон", "белый"],
  ...
  {
    id: "coffin-fklv-6s",
    name: "«Классика» ФКЛВ-6С",
    category: "Гробы",
    description: "Серия Классика, резьба «Тайная вечеря». Сосна, глянец.",
    imageUrl: "/catalog/coffins/fklv-6s.jpg",
    imagePlaceholder: "ФКЛВ",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["махагон", "тёмный"],
    tags: ["Классика", "сосна", "резьба"],
  },
  {
    id: "coffin-fko-6",
    name: "«Косичка» ФКО-6",
    category: "Гробы",
    description: "Серия Классика, декор «косичка». Сосна, глянец. 1,8-2,0 м.",
    imageUrl: "/catalog/coffins/fko-6.jpg",
    imagePlaceholder: "ФКО-6",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
    availableColors: ["махагон"],
  ...
  },
  {
    ...
    name: "«Сириус» ФСИ-6",
    category: "Гробы",
    description: "Серия Классика. Сосна, глянец, вишня. Размер 1,8-2,0 м.",
    imageUrl: "/catalog/coffins/fsi-6.jpg",
    imagePlaceholder: "ФСИ-6",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
  ...
  },
  {
    ...
    name: "«Сириус» ФСИ-6Б",
    category: "Гробы",
    description: "Серия Классика. Сосна, глянец, белый. Размер 1,8-2,0 м.",
    imageUrl: "/catalog/coffins/fsi-6b.jpg",
    imagePlaceholder: "ФСИ-6Б",
    clientPrice: 0,
    costPrice: 0,
    quantityDefault: 1,
  ...
  // ── Венки: реальные серии ПО «Фаворит» (фото из каталога) ──────────────
  {
    id: "wreath-standard",
    name: "Венок «Авторский»",
    category: "Венки",
    description: "Авторская композиция, размеры 120 / 140 см.",
    imageUrl: "/catalog/wreaths/avtorskie.jpg",
    imagePlaceholder: "ВА",
    clientPrice: 7000,
    costPrice: 2500,
    quantityDefault: 1,
    isRecommended: true,
    tags: ["венок", "авторский"],
  },
  {
    id: "wreath-improved",
    name: "Венок «Триколор»",
    category: "Венки",
    description: "Триколор / памятный, размеры 110 / 120 / 140 см.",
    imageUrl: "/catalog/wreaths/tricolor.jpg",
    imagePlaceholder: "ВТ",
    clientPrice: 12000,
    costPrice: 4500,
    quantityDefault: 1,
  ...
  },
  {
    ...
    name: "Венок «Цветопад»",
    category: "Венки",
    description: "Каскадная цветочная композиция.",
    imageUrl: "/catalog/wreaths/cvetopad.jpg",
    imagePlaceholder: "ВЦ",
    clientPrice: 9000,
    costPrice: 3500,
    quantityDefault: 1,
