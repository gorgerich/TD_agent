        ...
        <div className="mt-5 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={goNext}
              className="inline-flex min-h-10 items-center gap-1.5 rounded-full bg-accent px-4 py-2 text-[13px] font-semibold text-on-accent shadow-[0_14px_30px_-20px_rgba(37,99,235,0.8)] transition-transform duration-200 hover:-translate-y-0.5 hover:bg-accent-hover"
            >
              {isIntro ? (
