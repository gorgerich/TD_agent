...
export default function CoView({ code }: { code: string }) {
  ...
  return (
    <div className="mx-auto max-w-[680px]">
      ...
      {/* Grand total hero */}
      <div className="mb-5 overflow-hidden rounded-[var(--radius-card)] bg-accent shadow-[0_16px_40px_-20px_rgba(0,58,53,0.45)]">
        ...
        <div className="mb-5 space-y-3">
          {agreed ? (
            ...
            <button
              ...
              onClick={agree}
              disabled={agreeBusy}
              className="flex min-h-[52px] w-full items-center justify-center gap-2 rounded-full bg-accent px-6 font-semibold text-[14px] text-on-accent shadow-[0_14px_32px_-16px_rgba(0,58,53,0.55)] transition-colors hover:bg-accent-hover disabled:opacity-60"
            >
